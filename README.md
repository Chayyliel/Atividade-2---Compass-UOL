...
- Daremos o nome ao template, uma descrição e escolheremos as seguintes opções:
  ...
  - "Advanced details" = Adicionar um "User data" com as seguintes configurações:
    - ```bash
          ...
          sudo mount -t nfs4 -o nfsvers=4.1,rsize=1048576,wsize=1048576,hard,timeo=600,retrans=2,noresvport <id-efs>.efs.us-east-1.amazonaws.com:/ <caminho-diretorio-de-montagem>
          sudo sh -c 'echo "<id-efs>.efs.us-east-1.amazonaws.com:/ <caminho-diretorio-de-montagem> nfs4 -o nfsvers=4.1,rsize=1048576,wsize=1048576,hard,timeo=600,retrans=2,noresvport,_netdev 0 0" >> /etc/fstab'
